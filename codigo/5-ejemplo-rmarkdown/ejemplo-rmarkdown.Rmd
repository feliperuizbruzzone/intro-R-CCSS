...
Este documento es un ejemplo de exportación de resultados utilizando RMarkdown, para el curso introductorio al uso de RStudio para Ciencias Sociales efectuado durante **noviembre y diciembre de 2021** en Estación Lastarria.[^1]
