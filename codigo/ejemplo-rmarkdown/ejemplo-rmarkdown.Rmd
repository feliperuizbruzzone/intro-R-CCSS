...
linkcolor: blue
csl: apa.csl
subtitle: "Curso Introducción a R para Ciencias Sociales - Abril 2020"
...
Este documento es un ejemplo de exportación de resultados utilizando RMarkdown, para el curso introductorio al uso de RStudio para Ciencias Sociales efectuado durante **diciembre de 2019** en Estación Lastarria.[^1]

[^1]: Si lo ejecutan tal como está, pueden exportarlo a Html de manera directa. Si quieren exportarlo a PDF deberán editar el comando *stargazer* del apartado de regresión.
...
Para ejecutarlo, necesitarán tener instaladas algunas cuestiones adicionales. Existen diversas fuentes en línea en las cuales pueden encontrarse orietnaciones generales respecto al funcionamiento y uso de RMarkdown que incluimos a continuación como referencias [@grolemund_introduction_2014;@reproducible_research_workshop_writing_2016;@miller_r_2016;-@miller_pandoc_2018], podrán encontrar el final de este documento acceso a ellas mediante enlaces url.
...
También es altamente recomendable un libro (en inglés) publicado recientemente por los desarrolladores de las diferentes herramientas que componen RMarkdown titulado *RMarkdown: The Definitive Guide* [@yihui_r_2018]. En el enlace asociado a la referencia se encuentra una versión gratuita en línea de tal material.
...
En primer lugar tenemos el encabezado. Aquí se configuran las *propiedades* del reporte final. Se pueden indicar distintos elementos: título del documento, subtítulo, autor, fecha, bibliografía y su formato, si se numerarán los títulos, si se integrará un índice, así como el estilo de las notas y enlaces a la web.
...
Si se cambia el argumento *style* a la opción *'rmarkdown'*, y se indica la opciób *results = 'asis'* para el código de R, se obtendrá una tabla compilada en un formato procesable por RMarkdown.
